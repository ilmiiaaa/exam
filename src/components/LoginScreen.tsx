      ...
      <main className="max-w-md mx-auto w-full my-8 relative z-10">
        <div className="card-3d p-6 md:p-8 relative overflow-hidden bg-white text-slate-900 border-2 border-indigo-100 shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
          ...
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-black text-slate-900 font-heading">Masuk Exam Edu</h2>
          ...
          <form onSubmit={handleStart} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-3 py-3.5 px-5 btn-3d-indigo text-white text-sm font-black rounded-2xl flex items-center justify-center space-x-2 transition-all disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer"
            >
              {loading ? (
